  ...
  const sections = [
      ...
      content: (
        <div className="space-y-8">
          <p className="text-xl md:text-2xl font-light leading-relaxed text-slate-800 ">
            Postify is a sanctuary for modern expression. We designed this platform for sharing thoughts, ideas, and
            creativity without the noise of the typical algorithmic feeds. Whether you’re here to express opinions,
            explore trending content, or engage in meaningful discussions — we connect people through authentic
            conversations.
          </p>
          <div className="pt-10">
            ...
            <p className="text-slate-600 font-light leading-relaxed mb-10 text-lg">
              Our mission is to make posting simple, safe, and intelligent — powered by AI moderation, personalized
              recommendations, and a welcoming global community. We are building a space where creativity breathes and
              engagement thrives naturally.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 mt-12">
              <div className="group">
                <div className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center mb-5 group-hover:border-slate-800 transition-colors duration-300">
                ...
                <p className="text-slate-600 font-light leading-relaxed">
                  Every feature is designed to amplify the true voice of our creators, giving ideas the space they need
                  to resonate.
                </p>
              </div>
              <div className="group">
                ...
                <p className="text-slate-600 font-light leading-relaxed">
                  Our industry-leading moderation ensures your experience is focused on connection, not conflict.
                </p>
              </div>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-8">
          <p className="text-xl md:text-2xl font-light leading-relaxed text-slate-800 ">
            Your privacy matters profoundly to us. We collect only the minimal data necessary to deliver a secure and
            customized experience — such as your username, email, and the posts you choose to share.
          </p>
          ...
          <p className="text-slate-500 text-sm mt-8 border-l border-slate-300 pl-4">
            For specialized account or privacy inquiries, please contact our support team directly from your profile
            settings.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-8">
          <p className="text-xl md:text-2xl font-light leading-relaxed text-slate-800 ">
            By using Postify, you agree to respect our community guidelines. We are committed to maintaining a safe,
          ...
          <div className="mt-12 space-y-12">
            <div className="relative pl-6 md:pl-10">
              ...
              <p className="text-slate-600 font-light leading-relaxed">
                Users are strictly prohibited from posting harmful, illegal, or offensive material. Violations are
                addressed promptly and may result in the suspension or complete removal of your account footprint. We
                hold zero tolerance for hate speech, targeted harassment, or malicious content.
              </p>
            </div>
            <div className="relative pl-6 md:pl-10">
              ...
              <p className="text-slate-600 font-light leading-relaxed">
                While we moderate heavily, Postify acts as a platform for expression and is not legally liable for
                user-generated content or third-party actions. We ask every user to wield their platform presence
                responsibly and respectfully. All individual opinions expressed remain entirely autonomous.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 lg:py-32 flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
        <aside className="lg:w-1/3 flex-shrink-0">
          <div className="sticky top-32">
            <p className="text-slate-400 font-medium tracking-wide text-xs uppercase mb-4">Postify Directory</p>
            <h1 className="text-5xl lg:text-7xl font-serif mb-12 text-slate-900 leading-tight">
              About & <br /> Legal
            </h1>
        ...
        <main className="lg:w-2/3 space-y-32">
          {sections.map(({ id, title, subtitle, content }) => (
            <section
              key={id}
              id={id}
              className={` transition-all duration-300 ease-in-out ${activeTab === id ? 'opacity-100 translate-y-0' : 'opacity-30 translate-y-4 hover:opacity-75 cursor-pointer'}`}
              onMouseEnter={() => id !== activeTab && setActiveTab(id)}
              onClick={() => id !== activeTab && setActiveTab(id)}
            >
              <div className="mb-12 border-b border-slate-200 pb-8">
                <h2 className="text-4xl md:text-6xl font-serif mb-4 text-slate-900">{title}</h2>
